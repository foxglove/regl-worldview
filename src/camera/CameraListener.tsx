...
export default class CameraListener extends React.Component<Props> {
  ...
  _onWindowMouseMove = (e: MouseEvent) => {
    ...
    if ((document as any).pointerLockElement && (e.movementX || e.movementY)) {
  ...
  _getKeyMotion = (code: string): KeyMotion | null | undefined => {
  ...
  _onKeyUp = (e: React.KeyboardEvent<HTMLDivElement>) => {
    this._shiftKey = e.shiftKey;
    this._metaKey = e.metaKey;
    this._ctrlKey = e.ctrlKey;
