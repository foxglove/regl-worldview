...
export const p = (x: number, y: number = x, z: number = x) => ({
  x,
  y,
  z
});
export const q = (x: number, y: number = x, z: number = x, w: number = x) => ({
  x,
  y,
  z,
  w
...
export const withCustomRenderStates = (markers1: any, markers2: any) => {
  const magenta = markers1.map(marker => ({ ...marker,
    colors: [],
    color: {
      r: 1,
      g: 0,
  ...
  const gray = markers2.map(marker => ({ ...marker,
    colors: [],
    color: {
      r: 0.5,
      g: 0.5,
  ...
  const cyan = markers2.map(marker => ({ ...marker,
    colors: [],
    color: {
      r: 0,
      g: 1,
