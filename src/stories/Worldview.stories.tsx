...
storiesOf("Worldview", module).addDecorator(withKnobs).add("<Lines> - instability", () => {
  const points = [{
    x: -812.2277333190451,
    y: 2961.4633761946707,
    z: 0
  }, {
    x: -812.2718382693613,
    y: 2960.8755785794347,
    z: 0
  }, {
    x: -812.3047227216128,
    y: 2960.4388610900487,
    z: 0
  }, {
    x: -812.3249921796464,
    y: 2960.128621087491,
    ...
    x: -812.3563502479498,
    y: 2959.6420644182203,
    z: 0
  }, {
    x: -812.3563594592313,
    y: 2959.6419214945413,
    z: 0
  }, {
    x: -812.3563605869005,
    y: 2959.641903997451,
    ...
    x: -812.3563606674282,
    y: 2959.6419027479683,
    z: 0
  }, {
    x: -812.3563610277726,
    y: 2959.6418971568114,
    z: 0
  }, {
    x: -812.3563612249804,
    y: 2959.641894096902,
...
}).add("backgroundColor", withRange(range => {
  ...
  return <Container cameraState={DEFAULT_CAMERA_STATE} backgroundColor={[1, 1, 0, 1]}>
