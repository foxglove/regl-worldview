...
generateNonInstancedClickAssertions<SphereList>("Sphere", Spheres, twoSpheresInARow).forEach(({
  name,
  story
}) => stories.add(name, story));
generateInstancedClickAssertions<SphereList>("Sphere", Spheres, instancedSphere).forEach(({
  name,
  story
}) => stories.add(name, story));