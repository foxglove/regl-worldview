...
stories.add(`Clicks on a single Axis - worldview event handler`, assertionTest({
...
})).add(`Clicks on Axes with an object behind it - worldview event handler`, assertionTest({
