...
function textMarkers({
  ...
  randomScale?: boolean | null | undefined;
}) {
  const radius = 10;
  const count = 10;
...
storiesOf("Worldview/GLText", module).addParameters({
  screenshot: {
    delay: 200
  }
  ...
  const markers = overlappingMarkers({
...
}).add("billboard", () => <Container cameraState={{
  perspective: true,
  distance: 40
}}>
      <GLText>{textMarkers({
      ...
      <Axes />
    </Container>).add("non-billboard", () => <Container cameraState={{
  perspective: true,
  distance: 40
}}>
      <GLText>{textMarkers({
      ...
      <Axes />
    </Container>).add("no background", () => <Container cameraState={{
  perspective: true,
  distance: 40
}}>
      <GLText>{textMarkers({
      ...
      <Axes />
    </Container>).add("autoBackgroundColor", () => <Container cameraState={{
  perspective: true,
  distance: 40
}} backgroundColor={[0.2, 0.2, 0.4, 1]}>
      <GLText autoBackgroundColor>{textMarkers({
      text: "Hello\nWorldview"
    })}</GLText>
      <Axes />
    </Container>).add("autoBackgroundColor scaleInvariant", () => <Container cameraState={{
  perspective: true,
  distance: 40
}} backgroundColor={[0.2, 0.2, 0.4, 1]}>
    ...
    return <div style={{
      ...
      height: "100%"
        ...
        right: "10px"
            ...
            <input type="text" name="search" placeholder="search text" value={searchText} onChange={e => setSearchText(e.target.value)} />
          </div>
        </div>;
  };
      ...
      height: "100%"
        ...
        distance: 40
          ...
          right: "10px"
              ...
              <input type="color" name="highlight-color" value={tinyColor.fromRatio(highlightColor).toHexString()} onChange={e => {
