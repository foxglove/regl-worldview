...
type ConstructorArgs = {
  ...
  onCameraStateChange: ((arg0: CameraState) => void) | null | undefined;
...
export type DrawInput = {
  ...
  getChildrenForHitmap: GetChildrenForHitmap | null | undefined;
};
...
export type WorldviewContextType = {
  ...
  registerPaintCallback(arg0: PaintFn): void;
  unregisterPaintCallback(arg0: PaintFn): void;
  onUnmount(instance: Command<any>): void;
  onDirty(): void;
  readonly dimension: Dimensions;
  readonly initializedData: InitializedData | null | undefined;
};
...
export class WorldviewContext {
  ...
  initializedData: InitializedData | null | undefined;
  contextAttributes: Record<string, any> | null | undefined;
