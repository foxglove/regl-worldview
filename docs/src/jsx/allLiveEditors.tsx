...
function makeCodeComponent(raw, componentName, {
  ...
  return () => <WorldviewCodeEditor code={// For editors with noInline=true, the render() call will only work in the live editor,
  // not in the storybook
  code[1].trim().replace(/\/\/ #DOCS ONLY: /g, "")} nonEditableCode={code[0].trim()} componentName={componentName} isRowView={isRowView} insertCodeSandboxStyle={insertCodeSandboxStyle} noInline={noInline} />;
}

export const CameraStateControlled = makeCodeComponent(require("!!raw-loader!./api/CameraStateControlled"), "CameraStateControlled");
export const CameraStateUncontrolled = makeCodeComponent(require("!!raw-loader!./api/CameraStateUncontrolled"), "CameraStateUncontrolled");
export const MouseEvents = makeCodeComponent(require("!!raw-loader!./api/MouseEvents"), "MouseEvents", {
  isRowView: true
});
export const MouseEventsInstanced = makeCodeComponent(require("!!raw-loader!./api/MouseEventsInstanced"), "MouseEventsInstanced");
export const Arrows = makeCodeComponent(require("!!raw-loader!./commands/Arrows"), "Arrows");
export const ArrowsInteractive = makeCodeComponent(require("!!raw-loader!./commands/ArrowsInteractive"), "ArrowsInteractive");
...
export const FilledPolygonsHitmap = makeCodeComponent(require("!!raw-loader!./commands/FilledPolygonsHitmap"), "FilledPolygonsHitmap");
export const GLText = makeCodeComponent(require("!!raw-loader!./commands/GLText"), "GLText", {
  noInline: true
});
export const GLTextScaleInvariant = makeCodeComponent(require("!!raw-loader!./commands/GLTextScaleInvariant"), "GLTextScaleInvariant", {
  noInline: true
});
...
export const SpheresInstanced = makeCodeComponent(require("!!raw-loader!./commands/SpheresInstanced"), "SpheresInstanced");
export const SpheresInstancedColor = makeCodeComponent(require("!!raw-loader!./commands/SpheresInstancedColor"), "SpheresInstancedColor");
...
export const AddRemoveObstacles = makeCodeComponent(require("!!raw-loader!./tutorials/AddRemoveObstacles"), "AddingInteractivity");
...
export const FollowObjectOrientation = makeCodeComponent(require("!!raw-loader!./tutorials/FollowObjectOrientation"), "ManagingTheCamera");
export const HelloWorld = makeCodeComponent(require("!!raw-loader!./tutorials/HelloWorld"), "RenderingObjects");
export const InstancedRendering = makeCodeComponent(require("!!raw-loader!./tutorials/InstancedRendering"), "RenderingObjects");
export const MoveCamera = makeCodeComponent(require("!!raw-loader!./tutorials/MoveCamera"), "ManagingTheCamera");
export const StopReleaseDuck = makeCodeComponent(require("!!raw-loader!./tutorials/StopReleaseDuck"), "AddingInteractivity");