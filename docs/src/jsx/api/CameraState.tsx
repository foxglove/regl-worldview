...
import type { CameraState } from "@foxglove/regl-worldview";
import Worldview, { Arrows, Spheres, Axes, Grid, cameraStateSelectors } from "@foxglove/regl-worldview";
...
export default function Example() {
  ...
  const cameraPosition = cameraState.perspective ? vec3.copy([0, 0, 0], cameraStateSelectors.position({ ...cameraState,
