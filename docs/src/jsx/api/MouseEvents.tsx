...
function Example() {
  ...
  const randomCubeFacts = ["A cube is a three dimensional shape", "A cube has 6 square faces.", "A cube has the largest volume of all cuboids with a certain surface area", "All the matter that makes up the human race could fit in a sugar cube", "There are 43,252,003,274,489,856,000 possible permutations of the Rubik's Cube", "Ice Cube was the only member of NWA not born in Compton", "Wombats have cube-shaped poop"];
    ...
    height: 800
      ...
      <Worldview hitmapOnMouseMove onClick={onContainerClick} onMouseMove={onContainerMouseMove}>
        ...
        backgroundColor: "rgba(165, 94, 255, 0.1)"
          ...
          <div style={{
          margin: "5px 0"
        }}>you clicked on cube:</div>
          <pre style={{
          whiteSpace: "pre-wrap"
        }}>{JSON.stringify(cubeDetails, null, 2)}</pre>{" "}
