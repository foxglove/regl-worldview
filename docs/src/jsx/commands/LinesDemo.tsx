...
function Example() {
  ...
  const points = [[0, 0, 0], [0, 3, 0], [3, 3, 0], [3, 0, 0], [0, 0, 0], [0, 0, 3], [0, 3, 3], [3, 3, 3], [3, 0, 3], [0, 0, 3]];
  ...
  return <Worldview>
    ...
    }} thickness={thickness} setThickness={setThickness} debug={debug} setDebug={setDebug} joined={joined} setJoined={setJoined} scaleInvariant={scaleInvariant} setScaleInvariant={setScaleInvariant} closed={closed} setClosed={setClosed} monochrome={monochrome} setMonochrome={setMonochrome} />
      <Lines>{markers}</Lines>
      {debug && <Points>
          {[{
        points: [{
