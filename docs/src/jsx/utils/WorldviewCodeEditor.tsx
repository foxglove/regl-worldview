...
import Worldview, { Command, Arrows, Cones, Cubes, Cylinders, Grid, Lines, Points, Spheres, Triangles, Axes, FilledPolygons, DrawPolygons, PolygonBuilder, Overlay, Text, GLText, GLTFScene, DEFAULT_CAMERA_STATE, withPose, getCSSColor, intToRGB, cameraStateSelectors, getRayFromClick } from "@foxglove/regl-worldview";
...
${render}
`;
  return <CodeEditor scope={{ ...customScope,
    ...scope
  }} {...rest} noInline={noInline} codeSandboxConfig={CODE_SANDBOX_CONFIG} codeSandboxCode={codeSandboxCode} code={code} copyCode={copyCode} nonEditableCode={nonEditableCode} />;
}