...
function CodeEditor({
  ...
  return <StyledProvider code={code} scope={scope} noInline={noInline} mountStylesheet={false}>
      <LiveWrapper isRowView={isRowView}>
        <StyledEditor isRowView={isRowView} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
          {hovered && <StyledActions>
              ...
              {codeSandboxCode && <CodeSanboxLink codeSandboxCode={codeSandboxCode} codeSandboxConfig={codeSandboxConfig} />}
            </StyledActions>}
